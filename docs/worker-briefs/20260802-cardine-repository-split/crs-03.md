...
Implement `crs-03` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-03 Normalize Cardine repository identity and ownership

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-03.md`
