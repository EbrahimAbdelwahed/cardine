...
Implement `crs-02` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-02 Create and verify the autonomous private Cardine repository

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-02.md`
