...
Implement `crs-05` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-05 Run Cardine full verification and independent reviews

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-05.md`
