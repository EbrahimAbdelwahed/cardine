...
Implement `crs-07` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-07 Close migration with remote audit, tag, and durable handoff

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-07.md`
