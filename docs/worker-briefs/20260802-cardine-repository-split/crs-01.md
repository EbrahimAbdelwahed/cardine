...
Implement `crs-01` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-01 Preserve and prove every Cardine source

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-01.md`
