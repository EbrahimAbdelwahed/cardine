...
Implement `crs-04` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-04 Pin migration and packaging regression coverage

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-04.md`
