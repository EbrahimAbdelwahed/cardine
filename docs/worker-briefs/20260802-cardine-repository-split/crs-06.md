...
Implement `crs-06` from `docs/specs/separate-cardine-from-study-agent-harness.md`.

Task title: crs-06 Remove Cardine-specific Harness residues and retain generic shell

## Read First

- `docs/specs/separate-cardine-from-study-agent-harness.md`
- `docs/tasks/20260802-cardine-repository-split/crs-06.md`
- `docs/flywheel-runs/20260802-cardine-repository-split/context-pack.md`
