...
input.value = 'clinica'; input.dispatchEvent({{type: 'input'}}); const afterFilter = {{count: results.children.length, label: results.children[0].children[0].textContent}};
